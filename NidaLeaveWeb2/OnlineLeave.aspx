<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OnlineLeave.aspx.cs" Inherits="OnlineLeave" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="Server">
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type: 'POST',
                url: 'OnlineLeave.aspx/GetLeaveList',
                data: data,
        ...
        function leaveList() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: JSON.stringify({ haha: "ddd", tuan: "hahaha" }),
                async: false,
